...
//   label      count  spawnInt  { hp   spd   dano  t }  interv  arm  { hp   spd  dano  t }  chg  { hp    spd  dano  t }  nec  { hp   spd  dano  t }
  ...
  { "Onda  2",   15,    1.0f,    { 55, 1.8f,  10,  0 },  22.0f,   3,  { 110, 1.2f, 15,  1 },   0,  {   0, 0.0f,  0,  2 },   0,  {  0, 0.0f,  0,  3 } },
  { "Onda  3",  20,    0.9f,    { 60, 2.0f,  12,  0 },  25.0f,   5,  { 120, 1.3f, 18,  1 },   3,  { 150, 2.2f, 25,  2 },   0,  {  0, 0.0f,  0,  3 } },
